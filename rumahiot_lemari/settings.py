"""
Django settings for rumahiot_lemari project.
...
ROOT_URLCONF = 'rumahiot_lemari.urls'
...
WSGI_APPLICATION = 'rumahiot_lemari.wsgi.application'
...
# User dashboard statistic type
VALID_STATISTIC_TYPE = ['0','1','2']