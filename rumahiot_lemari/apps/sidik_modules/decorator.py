...
from rumahiot_lemari.apps.sidik_modules.authorization import LemariSidikModuleNoEmail, LemariSidikModule
from rumahiot_lemari.apps.user_profile.utils import RequestUtils, ResponseGenerator, LemariUtils
...
# Decorator to make sure user is authenticated (With email in user object)
def authentication_required_with_email(function):
